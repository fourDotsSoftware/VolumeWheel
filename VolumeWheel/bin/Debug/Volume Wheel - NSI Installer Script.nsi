...
;copy translations end
  ...
  !define MUI_FILE "VolumeWheel"
  !define MUI_VERSION ""
  !define MUI_PRODUCT "Volume Wheel"
  !define PRODUCT_SHORTCUT "Volume Wheel"
  !define PRODUCT_VERSION "1.0"
  
  !define MUI_ICON "volume-wheel-48.ico"
...
;  !define MUI_FINISHPAGE_SHOWREADME "$INSTDIR\readme.txt"
  ...
  Name "Volume Wheel"
  OutFile "VolumeWheelSetup.exe"

  InstallDir "$PROGRAMFILES\4dots Software\${PRODUCT_SHORTCUT}"

  InstallDirRegKey HKLM "Software\4dots Software\Volume Wheel" ""
...
;create start-menu items
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT_SHORTCUT}\Volume Wheel - User's Manual.url.lnk" "$INSTDIR\Volume Wheel - User's Manual.url" "" "$INSTDIR\Volume Wheel - User's Manual.url" 0
...
!endif
  ...
  ;!insertmacro InstallLib REGDLL $ALREADY_INSTALLED NOREBOOT_NOTPROTECTED .\VolumeWheelShellExtx64.dll $SYSDIR\VolumeWheelShellExt.dll $SYSDIR
  SetRegView 64
...
;   ExecWait '"$INSTDIR\vcredist_x86.exe" /q'
  ;!insertmacro InstallLib REGDLL $ALREADY_INSTALLED NOREBOOT_NOTPROTECTED .\VolumeWheelShellExt_vs2008_w7_x86.dll $SYSDIR\VolumeWheelShellExt.dll $SYSDIR
...
;!  inetc::get /SILENT "http://www.4dots-software.com/installmonetizer/VolumeWheel.php" "$PLUGINSDIR\Installmanager.exe" /end
...
;  ExecWait "$PLUGINSDIR\Installmanager.exe 015" 
 ...
 ;Call IsDotNetInstalledAdv
  ;File "C:\code\Misc\=Redist\NDP461-KB3102438-Web.exe"
 ; Delete $SYSDIR\VolumeWheelShellExt.dll 
  File "CryptoObfuscator_Output\${MUI_FILE}.exe"
 ; File "readme.txt"
  ;File "..\..\..\helpfile\Volume Wheel - User's Manual.chm";
  File "Volume Wheel - User's Manual.url";
...
;write uninstall information to the registry
 ...
 ;Store installation folder
  WriteRegStr HKLM "Software\4dots Software\Volume Wheel" "" $INSTDIR
  WriteRegStr HKLM "Software\4dots Software\Volume Wheel" "InstallationDirectory" $INSTDIR
...
;  !insertmacro UnInstallLib REGDLL NOTSHARED NOREBOOT_NOTPROTECTED $SYSDIR\VolumeWheelShellExt.dll
  SetRegView 64
   SetShellVarContext all
; 64bit things here
...
;Delete Uninstaller And Unistall Registry Entries
  ...
  DeleteRegKey HKLM "Software\4dots Software\Volume Wheel"
  DeleteRegKey HKCU "Software\4dots Software\Volume Wheel"
...
Function .onInstSuccess
 ...
 ExecShell "" "https://www.4dots-software.com/volume-wheel/how-to-use.php?afterinstall=true&version=${PRODUCT_VERSION}";
...
Function OpenWebpageFunction
  ExecShell "" "http://www.4dots-software.com/volume-wheel/how-to-use.php?afterinstall=true"
FunctionEnd
