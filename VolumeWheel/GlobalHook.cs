...
namespace VolumeWheel
{
    ...
    public abstract class GlobalHook
    {
        ...
        protected const int WM_NCMOUSEMOVE= 0x00A0; // WM_NCMOUSEMOVE
        protected const int WM_NCMOUSELEAVE = 0x02A2; // WM_NCMOUSELEAVE
        ...
        public void Start()
        {
                ...
                _hookType != 0)
            {
                ...
                _handleToHook = SetWindowsHookEx(
                    ...
                    _hookCallback,
                    (IntPtr)null,
                    //3Marshal.GetHINSTANCE(Assembly.GetExecutingAssembly().GetModules()[0]),
                    0);
